...
:class:`~hmls.singlemkii.model.MkIITankPolicyNetwork`.
"""
...
class NNPlayer(NNPlayerBase):
    ...
    Args:
        ...
        model: The :class:`MkIITankPolicyNetwork` to use for inference.
    ...
    @property
    def model(self) -> MkIITankPolicyNetwork:
    ...
    def _reset_model_state(self) -> None:
        """Reset both GRU hidden states to zeros."""
