"""Map generation base classes.

This module defines the :class:`MapStrategy` abstract base class for
pluggable obstacle-placement algorithms, the :class:`StrategyConfigBase`
Pydantic model for serialisable strategy configuration, and the
:data:`STRATEGY_REGISTRY` that maps display names to strategy classes.

The :func:`~hmls.mapgenerator.generators._generate.generate_map` entry
point lives in a separate module to avoid circular imports between
this module and concrete strategy implementations.
