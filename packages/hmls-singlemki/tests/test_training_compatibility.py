...
class TestMkIConfigCompatibility:
    ...
    def test_different_architecture_same_patch_size(self) -> None:
        ...
        config_a = ModelConfig(patch_size=9, cnn_channels=(32, 64), gru_hidden_size=128)
        config_b = ModelConfig(patch_size=9, cnn_channels=(16, 32, 64, 128), gru_hidden_size=256)
        _validate_model_configs(config_a, config_b)  # Should not raise
