...
class TestResolveModelPackage:
    ...
    def test_resolve_fallback_to_import(self) -> None:
        ...
        result = resolve_model_id("hmls.reinforcetrainer._testing")
