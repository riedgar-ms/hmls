...
class TestValidateAction:
    ...
    def test_turn_always_valid(self) -> None:
        ...
        assert validate_action(state, "a1", Action.TURN_RIGHT).valid

    def test_fire_always_valid(self) -> None:
        """Firing is always valid (regardless of what's ahead)."""
        state = _make_state()
        assert validate_action(state, "a1", Action.FIRE).valid

    def test_pass_always_valid(self) -> None:
        """Passing is always valid."""
        state = _make_state()
        assert validate_action(state, "a1", Action.PASS).valid
    ...
    def test_dead_tank_invalid(self) -> None:
        ...
        state = _make_state(tanks=tanks)
        result = validate_action(state, "a1", Action.PASS)
        assert not result.valid
    ...
    def test_wrong_turn_invalid(self) -> None:
        ...
        state = _make_state()
        result = validate_action(state, "b1", Action.PASS)
        assert not result.valid
    ...
    def test_nonexistent_tank_invalid(self) -> None:
        ...
        state = _make_state()
        result = validate_action(state, "zz", Action.PASS)
        assert not result.valid
...
class TestApplyAction:
    ...
    def test_move_forward(self) -> None:
        ...
        state = _make_state()
        new = apply_action(state, "a1", Action.MOVE_FORWARD)
    ...
    def test_pass_does_nothing(self) -> None:
        ...
        state = _make_state()
        new = apply_action(state, "a1", Action.PASS)
    ...
    def test_turn_wraps_around(self) -> None:
        ...
        state = _make_state()
        s1 = apply_action(state, "a1", Action.PASS)
        s2 = apply_action(s1, "b1", Action.PASS)
    ...
    def test_original_state_unchanged(self) -> None:
        ...
        _ = apply_action(state, "a1", Action.MOVE_FORWARD)
